...
&lt;/p></code></pre>
            ...
            <p>
                Чтобы отобразить содержимое струтурной директивы, необходимо воспользоваться методом
	...
	ngOnChanges() {
        this.appCustomDirective
            ...
            <p>
                ...
                передавать ключ <code>time</code>, значенем которого будет текущее время:
            </p>
            <pre><code class="language-typescript">// класс директивы
&#64;Directive({
	selector: '[appSomeDirective]',
...
export class SomeDirective {
	...
	ngOnChanges() {
        ...
        this.appCustomDirective
            ...
            <p>
                Сама же передача контекста элементу <code>ng-template</code> в случае со структуруными директивами будет
