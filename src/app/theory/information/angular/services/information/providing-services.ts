...
export const PROVIDING_SERVICES: IInfo = {
    ...
    body: `<p>
                ...
                указывается нужное значение. Второй способ рассмотрен в спойлере "<i>способы регистраций зависимостей в поле <code>providers</code></i>".
            </p>
...
export class AppComponent {
    constructor(private dataService: DataService) {
        console.log(this.dataService);
            ...
            <p>Более подробно про значение <code>null</code> описано в спойлере "<i>способы регистраций зависимостей в поле <code>providers</code></i>".</p>`,
    selected: false,
